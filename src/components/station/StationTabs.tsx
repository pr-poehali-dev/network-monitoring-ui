    ...
    <>
      <Tabs value={activeTab} onValueChange={onTabChange}>
        <TabsList className="mb-6 inline-flex h-10 items-center justify-start rounded-md bg-muted p-1 text-muted-foreground w-full overflow-x-auto">
          ...
          <TabsTrigger value="settings" className="whitespace-nowrap opacity-50 cursor-not-allowed" disabled>Настройки</TabsTrigger>
          <TabsTrigger value="errors" className="whitespace-nowrap opacity-50 cursor-not-allowed" disabled>Ошибки</TabsTrigger>
        ...
        <TabsContent value="stats">
          <StatisticsTab serialNumber={station.serialNumber} />
        </TabsContent>
        ...
        <TabsContent value="input-meter">
          <InputMeterTab serialNumber={station.serialNumber} />
        </TabsContent>
